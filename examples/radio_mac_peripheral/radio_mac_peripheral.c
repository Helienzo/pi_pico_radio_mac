...
/*
 This example demonstrates how to use the macRadio module as a peripheral device.
 The peripheral device searches or cental devices and tries to connect once found.
...
int main() {
    ...
    res = macRadioSetPeripheralMode(&main_instance.mac_radio);
